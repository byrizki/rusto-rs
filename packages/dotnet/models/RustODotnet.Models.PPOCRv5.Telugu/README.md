...
Pre-converted PP-OCRv5 Telugu MNN recognition model for [RustODotnet](https://www.nuget.org/packages/RustODotnet).

## Included Models

- `rec.mnn` (PP-OCRv5 Telugu Recognition)
- `dict.txt` (Telugu dictionary)
