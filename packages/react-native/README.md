...
dependencies {
    // Add your preferred OCR models:
    implementation 'com.github.byrizki.rusto-rs:rusto-models-ppocrv6-tiny:v0.2.2'     // ~6 MB (recommended default)
    // or implementation 'com.github.byrizki.rusto-rs:rusto-models-ppocrv6-small:v0.2.2'    // ~30 MB
    // or implementation 'com.github.byrizki.rusto-rs:rusto-models-ppocrv6-medium:v0.2.2'   // ~134 MB
    // or implementation 'com.github.byrizki.rusto-rs:rusto-models-ppocrv5-mobile:v0.2.2'   // ~28 MB
    // or implementation 'com.github.byrizki.rusto-rs:rusto-models-ppocrv4-mobile:v0.2.2'   // ~23 MB
}
```
